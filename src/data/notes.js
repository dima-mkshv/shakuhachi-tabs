export const OTSU_NOTES = [
  ...
  { semitoneOffset: 7,  romaji: 'Ha',       katakana: 'ハ',       fingering: [1, 0, 0, 0, 0],     technique: 'normal' },
...
export const KAN_NOTES = [
  ...
  { semitoneOffset: 19, romaji: 'Ha',       katakana: 'ハ',       fingering: [1, 0, 0, 0, 0],     technique: 'normal',  register: 'kan' },
